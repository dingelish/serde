...
//#[test]
pub fn test_generic_newtype_struct() {
    assert_tokens(
...
//#[test]
pub fn test_untagged_newtype_struct() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    #[serde(untagged)]
    enum E {
...
//#[test]
pub fn test_adjacently_tagged_newtype_struct() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
...
//#[test]
pub fn test_generic_tuple_struct() {
    assert_tokens(
...
//#[test]
pub fn test_generic_enum_newtype() {
    assert_tokens(
...
//#[test]
pub fn test_internally_tagged_enum() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
...
//#[test]
pub fn test_internally_tagged_bytes() {
    #[derive(Debug, PartialEq, Deserialize)]
    #[serde(tag = "type")]
    enum InternallyTagged {
        String {
...
//#[test]
pub fn test_internally_tagged_struct_variant_containing_unit_variant() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    pub enum Level {
        Info,
    }
...
//#[test]
pub fn test_internally_tagged_borrow() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    #[serde(tag = "type")]
    pub enum Input<'a> {
        Package { name: &'a str },
...
//#[test]
pub fn test_adjacently_tagged_enum() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    #[serde(tag = "t", content = "c")]
...
//#[test]
pub fn test_adjacently_tagged_enum_deny_unknown_fields() {
    #[derive(Debug, PartialEq, Deserialize)]
...
//#[test]
pub fn test_enum_in_internally_tagged_enum() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    #[serde(tag = "type")]
    enum Outer {
        Inner(Inner),
...
//#[test]
pub fn test_internally_tagged_struct() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    #[serde(tag = "type")]
    pub struct Struct {
        a: u8,
...
//#[test]
pub fn test_internally_tagged_braced_struct_with_zero_fields() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    #[serde(tag = "type")]
    struct S {}
...
//#[test]
pub fn test_internally_tagged_struct_with_flattened_field() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
...
//#[test]
pub fn test_enum_in_untagged_enum() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    #[serde(untagged)]
    enum Outer {
        Inner(Inner),
...
//#[test]
pub fn test_untagged_newtype_variant_containing_unit_struct_not_map() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    struct Unit;
...
//#[test]
pub fn test_internally_tagged_newtype_variant_containing_unit_struct() {
    #[derive(Debug, PartialEq, Serialize, Deserialize)]
    struct Info;
